import { DescriptorMapElement, InputDescriptorConstraintFieldType, InputDescriptorType, PresentationSubmission } from "./presentationDefinition.type";
import Ajv from "ajv";
  ...
  public static verifyVcJwtWithDescriptor(descriptor: InputDescriptorType, vcjwt: string): boolean {
    ...
    const fieldsList: InputDescriptorConstraintFieldType[] = JSONPath({
      ...
      json: descriptor,
		...
		const payload: any = JSON.parse(base64url.decode(vcjwt.split(".")[1]))
